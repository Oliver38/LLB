...
namespace LLB.Controllers
{
    ...
    public class InspectorController : Controller
    {
        ...
        public InspectorController(AppDbContext db, UserManager<ApplicationUser> userManager, RoleManager<IdentityRole> roleManager, SignInManager<ApplicationUser> signInManager, IDNTCaptchaValidatorService validatorService)
        {
            _db = db;

...
namespace LLB.Controllers
{
    ...
    public class ViewingController : Controller
    {
        ...
        public ViewingController(AppDbContext db, UserManager<ApplicationUser> userManager, SignInManager<ApplicationUser> signInManager, IDNTCaptchaValidatorService validatorService)
        {
            _db = db;
